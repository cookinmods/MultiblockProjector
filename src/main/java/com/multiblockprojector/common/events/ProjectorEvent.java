...
public class ProjectorEvent extends Event implements ICancellableEvent {
    ...
    public static class PlaceBlock extends ProjectorEvent {
        public PlaceBlock(MultiblockDefinition multiblock, Level templateWorld, BlockPos templatePos,
    ...
    public static class PlaceBlockPost extends ProjectorEvent {
        public PlaceBlockPost(MultiblockDefinition multiblock, Level templateWorld, BlockPos templatePos,
                             Level world, BlockPos worldPos, BlockState state, Rotation rotation) {
            super(multiblock, templateWorld, templatePos, world, worldPos, state, rotation);
        }
    }
    ...
    public static class RenderBlock extends ProjectorEvent {
        public RenderBlock(MultiblockDefinition multiblock, Level templateWorld, BlockPos templatePos,
                          Level world, BlockPos worldPos, BlockState state, Rotation rotation) {
            super(multiblock, templateWorld, templatePos, world, worldPos, state, rotation);
        }
    ...
    protected MultiblockDefinition multiblock;
    ...
    public ProjectorEvent(MultiblockDefinition multiblock, Level templateWorld, BlockPos templatePos,
                         Level world, BlockPos worldPos, BlockState state, Rotation rotation) {
        super();
    ...
    public MultiblockDefinition getMultiblock() { return multiblock; }
